    ...
    <div>
      ...
      <div>
        ...
        <div style={{ display: "flex" }} >
          ...
          <DropdownButton id="dropdown-basic-button" variant="dark" title={!!!sort ? "Sort" : sort.toUpperCase().replaceAll("_", " ")} className="ml-3" style={{ width: '200px' }}>
